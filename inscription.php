		...
		<div id="cadre"> <!-- corps de la page  -->
			...
			<div class="container" id="wrap">
				...
				<div class="col-md-6 col-md-offset-3">
					<form action="r" method="post" accept-charset="utf-8" class="form" role="form">   <legend>Création d'un compte client</legend>
						<h4>C'est gratuit, et ce pour toujours.</h4>
						<div class="row">
						<div class="col-xs-6 col-md-6">
							<input type="text" name="nom" value="" class="form-control input-lg" placeholder="Nom"  />                        </div>
						<div class="col-xs-6 col-md-6">
								<input type="text" name="prenom" value="" class="form-control input-lg" placeholder="Prénom"  />                        </div>
						</div>
							<input type="text" name="email" value="" class="form-control input-lg" placeholder="Votre Email"  />
							<input type="password" name="password" value="" class="form-control input-lg" placeholder="Votre mot de passe"  />
							<input type="password" name="confirm_password" value="" class="form-control input-lg" placeholder="Confirmer votre mot de passe"  />                    
						...
						<div class="col-xs-4 col-md-4">
							...
							<div class="col-xs-4 col-md-4">
								<select name="year" class = "form-control input-lg">
									...
									<label>Sexe : </label>                    <label class="radio-inline">
										<input type="radio" name="gender" value="M" id=male /> Masculin
									</label>
									<label class="radio-inline">
										<input type="radio" name="gender" value="F" id=female />Féminin
									</label>
									<br />
